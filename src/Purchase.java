...
public class Purchase extends JFrame  {
	...
	int Stop=0;String UID="",Code="",PID="";
...
private JTextField textField_8;
	...
	public Purchase() throws IOException {
		File fff=new File(Data.path+"product.txt");
		if(fff.exists()==false)
		{
			fff.createNewFile();
			WriteFile W=new WriteFile(Data.path+"product.txt",true);
			W.writeToFile("P001§Select Product§Select Product Code§");
		...
		JButton btnEditConsigner = new JButton("Edit Product");
		...
		JButton btnDeleteConsigner = new JButton("Delete Product");
		...
		String[] companyName=Data.getSecond(Data.path+"buyer.txt");
		@SuppressWarnings("unchecked")
		...
		new ItemListener(){
			...
			public void itemStateChanged(ItemEvent arg0) {
				try {
					String selected=Data.getLine("B00"+(comboBox_1.getSelectedIndex()+1)+"", Data.path+"buyer.txt");
					UID="B00"+(comboBox_1.getSelectedIndex()+1);
					String secondWord=Data.getSecondWord(selected);
					textField_4.setText(Data.getFourthWord(selected));
		...
		comboBox_1.setBounds(314, 155, 345, 28);
		getContentPane().add(comboBox_1);
		
		
		JButton btnAddEntry = new JButton("Purchase");
		btnAddEntry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					File file=new File(Data.path+"ledger.txt");
					...
					String pLine=Data.getProductLine(PID, Data.path+"ledger.txt");
					...
					String addLine=PID+"§"+label.getText()+"§"+Code+"§"+label_1.getText()+"§"+textField.getText()+"§"+"Purchase"+
					"§"+textField_8.getText()+"§"+textField_1.getText()+"§"+textField_2.getText()+"§"+
					Stock+"§"+textField_3.getText()+"§"+textField_4.getText()+"§"+
		...
		btnAddEntry.setBounds(401, 662, 130, 28);
		getContentPane().add(btnAddEntry);
		
		
		JLabel lblCompanyName = new JLabel("Purchase Rate \u20B9");
		...
		lblCompanyName.setBounds(218, 215, 211, 28);
		getContentPane().add(lblCompanyName);
		
		JLabel lblCompanyAddress = new JLabel("MRP \u20B9");
		...
		lblCompanyAddress.setBounds(228, 267, 211, 28);
		...
		JLabel lblContactNumber_1 = new JLabel("Purchase Date");
		...
		lblContactNumber_1.setBounds(218, 366, 211, 28);
		getContentPane().add(lblContactNumber_1);
		
		JLabel lblEmail = new JLabel("Supplier's GSTIN");
		...
		JLabel lblNewEntry = new JLabel("Purchase");
		...
		lblNewEntry.setBounds(340, 49, 275, 58);
		getContentPane().add(lblNewEntry);
		
		lblEntryEdited = new JLabel("Product Purchased");
		...
		lblEntryEdited.setBounds(367, 690, 199, 28);
		...
		label.setBounds(243, 185, 211, 28);
		...
		lblExpiryDate.setBounds(218, 522, 211, 28);
		...
		lblInvoiceNumber.setBounds(218, 570, 211, 28);
		...
		lblTaxPaid.setBounds(218, 621, 211, 28);
