...
public class Consigner extends JFrame  {
	...
	public Consigner() {
		...
		btnAddEntry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try
				{
					File file=new File(Data.path+"supplier.txt");
					if(file.exists()==false)
					{
						file.createNewFile();
						WriteFile W=new WriteFile(Data.path+"supplier.txt",true);
						W.writeToFile("C001§Select Supplier§Select Address§Select Contact§Select Email");
					}
					WriteFile W=new WriteFile(Data.path+"supplier.txt",true);
					int compCount=Data.getLines(Data.path+"supplier.txt");
					W.writeToFile("C00"+compCount+"§"+textField.getText()+"§"+textField_1.getText()+"§"+textField_2.getText()+"§"+
