...
public class Consignee1 extends JFrame  {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Consignee1 frame = new Consignee1();
	...
	public Consignee1() throws IOException {
		...
		btnAddEntry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					...
					Data.editDatabase(UID, newLine, Data.path+"buyer.txt");
					textField.setText("");
					textField_1.setText("");
					textField_2.setText("");
					textField_3.setText("");
		...
		String[] buyerName=Data.getSecond(Data.path+"buyer.txt");
		@SuppressWarnings("unchecked")
		final JComboBox comboBox = new JComboBox(buyerName);
		...
		new ItemListener(){
			...
			public void itemStateChanged(ItemEvent arg0) {
				try {
					...
					{
						Stop++;
						String selected=Data.getLine("B00"+(comboBox.getSelectedIndex()+1)+"", Data.path+"buyer.txt");
						UID="B00"+(comboBox.getSelectedIndex()+1);
