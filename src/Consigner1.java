...
public class Consigner1 extends JFrame  {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Consigner1 frame = new Consigner1();
	...
	public Consigner1() throws IOException {
		...
		JButton btnViewConsigner = new JButton("View Consigner");
		btnViewConsigner.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					Consigner3 C=new Consigner3();
					C.setVisible(true);
				}catch(Exception vrs){}
			}
		});
		...
		textField.setBounds(475, 288, 247, 28);
		...
		btnAddEntry.setBounds(421, 630, 130, 28);
		getContentPane().add(btnAddEntry);
		
		String[] supplierName=Data.getSecond(Data.path+"supplier.txt");
		...
		new ItemListener(){
			...
			public void itemStateChanged(ItemEvent arg0) {
				try {
					...
					{
						Stop++;
						String selected=Data.getLine("C00"+(comboBox.getSelectedIndex()+1)+"", Data.path+"supplier.txt");
						UID="C00"+(comboBox.getSelectedIndex()+1);
						String secondWord=Data.getSecondWord(selected);
						label.setText(secondWord+"");
						textField.setText(secondWord);
						textField_1.setText(Data.getThirdWord(selected));
						textField_2.setText(Data.getFourthWord(selected));
						textField_3.setText(Data.getFifthWord(selected));
						textField_4.setText(Data.getSixthWord(selected));
					}	
				}catch (Exception e) {}					
			}
		});
		comboBox.setBounds(303, 201, 345, 39);
		...
		lblCompanyName.setBounds(221, 288, 211, 28);
		...
		lblCompanyAddress.setBounds(221, 358, 211, 28);
		...
		lblContactNumber.setBounds(221, 423, 211, 28);
		...
		lblContactNumber_1.setBounds(221, 489, 211, 28);
		...
		lblEmail.setBounds(221, 552, 211, 28);
		getContentPane().add(lblEmail);
		
		JLabel lblNewEntry = new JLabel("Edit Entry");
		...
		lblEntryEdited = new JLabel("Entry Edited");
		...
		lblEntryEdited.setBounds(391, 671, 189, 28);
		...
		label.setBounds(248, 247, 474, 28);
