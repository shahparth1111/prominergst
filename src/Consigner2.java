...
public class Consigner2 extends JFrame  {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Consigner2 frame = new Consigner2();
	...
	public Consigner2() throws IOException {
		...
		JButton btnAddEntry = new JButton("Delete");
		btnAddEntry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				
				try{
					Data.deleteDatabase(UID, Data.path+"supplier.txt");
					textField.setText("");
					textField_1.setText("");
					textField_2.setText("");
					textField_3.setText("");
		...
		JLabel lblNewEntry = new JLabel("Delete Entry");
		...
		lblEntryEdited = new JLabel("Entry Deleted");
