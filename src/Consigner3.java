...
public class Consigner3 extends JFrame  {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Consigner3 frame = new Consigner3();
	...
	public Consigner3() throws IOException {
		...
		textField.setBounds(474, 313, 247, 28);
		...
		lblCompanyName.setBounds(220, 313, 211, 28);
		...
		lblCompanyAddress.setBounds(220, 383, 211, 28);
		...
		lblContactNumber.setBounds(220, 448, 211, 28);
		...
		lblContactNumber_1.setBounds(220, 514, 211, 28);
		...
		lblEmail.setBounds(220, 577, 211, 28);
		getContentPane().add(lblEmail);
		
		JLabel lblNewEntry = new JLabel("View Entry");
